...
To simply use the latest stable version, run
    ...
    docker run -d -p 9987:9987/udp -p 10011:10011 -p 30033:30033 --name=ts3-server joramk/teamspeak3-server
...
If you are starting the server for the first time, you need the Admin-Token:
    ...
    docker run -d -e TS3SERVER_LICENSE=accept -p 9987:9987/udp -p 10011:10011 -p 30033:30033 --name=ts3-server joramk/teamspeak3-server
